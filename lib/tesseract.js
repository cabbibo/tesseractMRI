...
function updateTesseractModel(){
  ...
  tesseractModel.rotation.x += .004;
  tesseractModel.rotation.y += .005;
  tesseractModel.rotation.z += .003;
  ...
  for( var i = 0; i < tesseractModel.corners.length; i ++ ){
    ...
    if( tesseractModel.corners[i].material.opacity <= 0 ){
      tesseractModel.remove(tesseractModel.corners[i]);
    }
